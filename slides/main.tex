...
\begin{frame}{这次研究到底在研究什么}
\begin{columns}
\begin{column}{0.42\textwidth}
  \centering
  \includegraphics[width=0.9\linewidth]{assets/undraw_ai_data_extraction.png}
\end{column}
\begin{column}{0.58\textwidth}
  ...
  \begin{itemize}[<+->]
    ...
    \item 结论预告：\texttt{SKILL.md} 不只是说明文档；它会影响 LLM 决策，\texttt{handler.py} 还会以 Agent 权限执行。
  \end{itemize}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.34\textwidth}
  \centering
  \includegraphics[width=\linewidth]{assets/undraw_markdown_file.png}
\end{column}
...
\begin{frame}{素材与参考来源}
  ...
  \begin{itemize}
    ...
    \item 风险分类参考：OWASP Top 10 for LLM Applications。\\
